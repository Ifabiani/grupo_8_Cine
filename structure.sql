...
ALTER TABLE `actor_movie` ADD CONSTRAINT `FK_987b0cb7-e169-47a3-874e-b24b0dbe01a8` FOREIGN KEY (`actor_id`) REFERENCES `actors`(`id`)  ;

ALTER TABLE `actor_movie` ADD CONSTRAINT `FK_d29faafe-bf60-4071-946f-1886bd85d0c9` FOREIGN KEY (`movie_id`) REFERENCES `movies`(`id`)  ;

ALTER TABLE `director_movie` ADD CONSTRAINT `FK_89ca4618-0320-406c-8cb2-a793162d44d7` FOREIGN KEY (`director_id`) REFERENCES `director`(`id`)  ;

ALTER TABLE `director_movie` ADD CONSTRAINT `FK_6a115c39-445b-46db-afc2-5155823d3f76` FOREIGN KEY (`movie_id`) REFERENCES `movies`(`id`)  ;
